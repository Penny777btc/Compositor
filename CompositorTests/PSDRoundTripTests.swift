...
struct PSDRoundTripTests {
    ...
    @Test func strokedRectangleImportsAsALiveShapeAndReportsTheStroke() throws {
        ...
        let strokeNote = L10n.text("The Photoshop stroke isn’t supported on shape layers and was omitted.")
        #expect(live.notes.contains(strokeNote))
        ...
        #expect(!imported.conversions.contains { $0.message.contains(L10n.text("Vector shape was rasterized to pixels.")) })
    }
