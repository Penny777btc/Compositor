...
nonisolated enum PSDError: LocalizedError, Equatable {
    ...
    var errorDescription: String? {
        switch self {
        case .truncated: L10n.text("The Photoshop file could not be read. It may be damaged or incomplete.")
        case .unsupportedVersion: L10n.text("Large Document (.psb) Photoshop files aren’t supported.")
        case .unsupportedColorMode: L10n.text("Only 8-bit RGB Photoshop files can be imported.")
        case .unsupportedDepth: L10n.text("Only 8-bit RGB Photoshop files can be imported.")
        case .unsupportedCompression: L10n.text("This Photoshop file uses a layer compression method that isn’t supported.")
        }
    }
}
