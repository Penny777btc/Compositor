...
nonisolated enum ProjectError: LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .version(let version): L10n.format("This project uses format version %lld. This app supports versions 1–10.", version)
...
actor ProjectStore {
    ...
    private func readPackage(_ url: URL) throws -> ProjectSnapshot {
        ...
        guard (1...10).contains(header.version) else { throw ProjectError.version(header.version) }
    ...
    private func validate(_ manifest: ProjectManifest) throws {
        ...
        guard (1...10).contains(manifest.version) else { throw ProjectError.version(manifest.version) }
        ...
        for layer in manifest.layers {
            ...
            if let generation = layer.generation {
                guard manifest.version >= 10, layer.isGroup != true, layer.adjustment == nil,
                      layer.shape == nil, layer.text == nil, layer.gradient == nil,
