...
struct ContentView: View {
    ...
    private var toolHelp: String {
        ...
        case .shape:
            return L10n.format("Drag to draw a shape on a new layer · Shift %@ · Option from center · Shift-U %@ · Escape cancel · Space to pan",
                               L10n.text(session.shapeKind == .rectangle ? "square" : "circle"),
                               L10n.text(session.shapeKind == .rectangle ? "ellipse" : "rectangle"))
        case .gradient:
